START_DIR = /home/coopar7/Dropbox/Projects/Matlab/MyToolbox/Testing
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/test_parfor"
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/test_parfor/interface"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/test_parfor/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/test_parfor/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/test_parfor/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
